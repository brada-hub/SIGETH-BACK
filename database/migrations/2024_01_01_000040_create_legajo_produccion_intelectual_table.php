...
return new class extends Migration
{
    ...
    {
        Schema::create('legajo_produccion_intelectual', function (Blueprint $table) {
            $table->id();
            $table->foreignId('empleado_id')->constrained('empleados')->onDelete('cascade');

            $table->string('titulo', 500);
            $table->text('referencia_bibliografica')->nullable();
            $table->string('año', 4);
    ...
    {
        Schema::dropIfExists('legajo_produccion_intelectual');
    }
};
