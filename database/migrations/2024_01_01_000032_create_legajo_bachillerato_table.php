...
return new class extends Migration
{
    ...
    {
        Schema::create('legajo_bachillerato', function (Blueprint $table) {
            $table->id();
            $table->foreignId('empleado_id')->unique()->constrained('empleados')->onDelete('cascade');

            $table->string('titulo_obtenido', 255)->default('Bachiller en Humanidades');
            $table->string('año', 4);
    ...
    {
        Schema::dropIfExists('legajo_bachillerato');
    }
};
