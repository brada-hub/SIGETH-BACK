...
return new class extends Migration
{
    ...
    {
        Schema::create('legajo_posgrado', function (Blueprint $table) {
            $table->id();
            $table->foreignId('empleado_id')->constrained('empleados')->onDelete('cascade');

            $table->string('tipo_postgrado', 100)->nullable()->comment('Diplomado, Especialidad, Maestría, Doctorado');
            $table->string('titulo_obtenido', 255);
            $table->string('carga_horaria', 50)->nullable();
            $table->string('año_titulacion', 4);
            ...
            $table->string('area_estudios', 255)->nullable();
    ...
    {
        Schema::dropIfExists('legajo_posgrado');
    }
};
